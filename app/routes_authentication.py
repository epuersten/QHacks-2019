...
def register():
    ...
    if form.validate_on_submit():
        user = NetUser(email=form.email.data, first_name=form.first_name.data, last_name=form.last_name.data, program_name=form.program.data, school_name=form.school.data)
